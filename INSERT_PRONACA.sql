...
(3,"Banco Pichincha","1.1.1.01.",1,5000.0),(3,"Banco Internacional","1.1.1.02.",1,5000.0),
(2,"Inventario","1.1.2.",1,0.0),(6,"Materia prima","1.1.2.01.",1,0.0),(6,"Insumos","1.1.2.02",1,0.0),
(6,"Producto","1.1.2.03.",1,0.0),(6,"Subproducto","1.1.2.04.",1,0.0),(1,"Activos fijos","1.2.",1,0.0),
(11,"Propiedad planta y equipo","1.2.1.",1,0.0),(11,"Depreciaciones acumuladas","1.2.2.",1,0.0),
(null,"Pasivos","2.",1,0.0),(14,"Pasivos corrientes","2.1.",1,0.0),
(15,"Cuentas por pagar","2.1.1.",1,0.0),(16,"Proveedor","2.1.1.01.",1,0.0),
(15,"Anticipo de clientes","2.1.2.",1,0.0),(15,"Obligaciones fiscales por pagar","2.1.3.",1,0.0),
(19,"IVA en ventas","2.1.3.01.",1,0.0),(19,"Retención del IVA","2.1.3.02.",1,0.0),
(15,"Obligaciones con el IESS","2.1.4.",1,0.0),(22,"Aporte personal por pagar","2.1.4.01.",1,0.0),
(22,"Aporte patronal por pagar","2.1.4.02.",1,0.0),(15,"Provisión beneficios sociales","2.1.5.",1,0.0),
(15,"Sueldos, comisiones por pagar","2.1.6.",1,0.0),(26,"Nómina por pagar","2.1.6.01.",1,0.0),
(14,"Pasivos fijos","2.2.",1,0.0),(28,"Obligaciones financieras","2.2.1.",1,75.526),(28,"Pasivos por arrendamiento","2.2.2.",1,3.571),
(null,"Patrimonio","3.",1,0.0),(31,"Capital","3.1.",1,407.166),(31,"Reservas","3.2.",1,130.000),(null,"Ingresos","4.",2,0.0),
(34,"Ingresos operativos","4.1.",2,0.0),(35,"Ventas y devoluciones","4.1.1.",2,0.0),(36,"Ventas","4.1.1.01.",2,0.0),(36,"Devoluciones","4.1.1.02.",2,0.0),
(null,"Costos","5",2,0.0),(39,"Costos Directos","5.1.",2,0.0),(40,"Costos operativos","5.1.1.",2,0.0),
(41,"Costos personal comercial","5.1.1.01",2,0.0),(41,"Costos personal producción","5.1.1.02.",2,0.0),
(40,"Costos de ventas","5.1.2.",2,0.0),(44,"Costos de ventas de mercancia","5.1.2.01.",2,0.0),(null,"Gastos","6.",2,0.0),(46,"Gastos operativos","6.1.",2,0.0),
(47,"Gastos nómina","6.1.1.",2,0.0),(48,"Gastos personal administrativo","6.1.1.01",2,0.0),(48,"Gastos personal financiero","6.1.1.02.",2,0.0);

INSERT INTO departamento( ID_CUENTA, NOMBRE_DEPARTAMENTO,CODIGO_CUENTA, CUENTA) VALUES (49,'Administrativo','6.1.1.01.','Gastos personal administrativo');
INSERT INTO `departamento`(`ID_CUENTA`, `NOMBRE_DEPARTAMENTO`, `CODIGO_CUENTA`, `CUENTA`) VALUES (43,'Produccion','5.1.1.02.','Costos personal producción');
INSERT INTO departamento( ID_CUENTA, NOMBRE_DEPARTAMENTO,CODIGO_CUENTA, CUENTA) VALUES (42,'Comercial','5.1.1.01.','Costos personal comercial');
INSERT INTO `departamento`(`ID_CUENTA`, `NOMBRE_DEPARTAMENTO`, `CODIGO_CUENTA`, `CUENTA`) VALUES (50,'Financiero','6.1.1.02.','Gastos personal financiero');
...
/*PEDIDOS*/
INSERT INTO `pedido` (`ID_PEDIDO`, `ID_CLIENTE`, `ID_EMPLEADO`, `ID_CUENTA`, `FECHA_PEDIDO`, `ESTADO_PEDIDO`) VALUES (NULL, '1', '1', NULL, '2023-02-26', 'Entregado');
/*DETALLE PEDIDOS*/
INSERT INTO `detalle_pedido` (`ID_DETALLE_PEDIDO`, `ID_PEDIDO`, `ID_ITEM`, `CANTIDAD_PEDIDO`, `PRECIO_DETALLE_PEDIDO`) VALUES (NULL, '1', '3', '20', '0.99');