...
BEGIN
  ...
  SELECT SUM(SUBTOTAL_DETALLE_PEDIDO) INTO subtotal FROM DETALLE_PEDIDO WHERE ID_PEDIDO = NEW.ID_PEDIDO;
  SELECT SUM(PRECIO_DETALLE_PEDIDO) INTO total FROM DETALLE_PEDIDO WHERE ID_PEDIDO = NEW.ID_PEDIDO;
  
  -- Actualiza los campos SUBTOTAL_PEDIDO y TOTAL_PEDIDO de la tabla PEDIDO
  UPDATE PEDIDO SET IVA_PEDIDO = total-subtotal,SUBTOTAL_PEDIDO = subtotal, TOTAL_PEDIDO = total WHERE ID_PEDIDO = NEW.ID_PEDIDO;
END$$
DELIMITER ;